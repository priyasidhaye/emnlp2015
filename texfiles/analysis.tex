...
\todo{This section needs to be proofread and rewritten to be clearer.}
...
\todo{Don't understand this equation. Why is there a limit?}
\begin{figure}[htbp]
\centering
